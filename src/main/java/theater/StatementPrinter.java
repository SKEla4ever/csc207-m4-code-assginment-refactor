...
public class StatementPrinter {
    ...
    public String statement() {
        ...
        result.append(String.format("You earned %s credits%n", getVolumnCredits()));
    ...
    private int getVolumnCredits() {
        int volumnCredits = 0;
        for (Performance performance : invoice.getPerformances()) {
            // add volume credits
            volumnCredits += getVolumeCredits(performance);
        }
    ...
    private int getVolumeCredits(Performance performance) {
        int rslt = Math.max(performance.getAudience() - Constants.BASE_VOLUME_CREDIT_THRESHOLD, 0);
    ...
    /**
     * This class generates a play.
     * @param performance get play
     * @return rslt result
     */
